...
#ggplot(data = treeringsites) +
#  geom_bar(aes(x = TYPE, y = COR), stat = "identity")

treeringsites_rm5 = subset(treeringsites, FINAL == 0)
treeringsites = subset(treeringsites, FINAL == 1)

#ggplot(data = treeringsites) +
#  geom_boxplot(aes(y = COR)) +
#  geom_boxplot(aes(x = LAND, y = COR)) +
#  geom_boxplot(aes(x = TYPE, y = COR)) +
#  geom_boxplot(aes(x = GENUS, y = COR))

Cor.p = ggplot(data = treeringsites) +
  geom_hline(yintercept = 0, col = "gray48") +
  geom_point(data = treeringsites_rm5, aes(x = 1, y = COR), shape = 1) +
  ...
  scale_y_continuous(name = "Correlation", expand = c(0,0), limits = c(-0.35, 0.65)) +
...
Cor.Land.p = ggplot(data = treeringsites) +
  geom_hline(yintercept = 0, col = "gray48") +
  geom_point(data = treeringsites_rm5, aes(x = LAND, y = COR), shape = 1) +
...
Cor.Type.p = ggplot(data = treeringsites) +
  geom_hline(yintercept = 0, col = "gray48") +
  geom_point(data = treeringsites_rm5, aes(x = TYPE, y = COR), shape = 1) +
...
Cor.Genus.p = ggplot(data = subset(treeringsites, GENUS == "Ace" | GENUS == "Thu")) +
  geom_hline(yintercept = 0, col = "gray48") +
  geom_point(data = subset(treeringsites_rm5, GENUS == "Ace" | GENUS == "Thu"),
             aes(x = GENUS, y = COR), shape = 1) +
...
tiff("SiteCor2.tiff", units = "in", width = 4, height = 3.5, res = 300)
Cor.p | Cor.Land.p | Cor.Type.p | Cor.Genus.p
dev.off()
