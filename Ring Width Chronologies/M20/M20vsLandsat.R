...
###ByStem###
ByStem <- read.rwl('M20_ByStem_2.rwl') #Update for each site
...
ByStem_Thuja <- read.rwl('M20_ByStem_Thuja_2.rwl') #Update for each site

#No Detrending
ByStem_Thuja_NoDetrend_Mean <- chron(ByStem_Thuja)
plot(ByStem_Thuja_NoDetrend_Mean)

#Detrending#
ByStem_Thuja_Spline <- detrend(ByStem_Thuja, method = c("Spline"))
ByStem_Thuja_Spline_Mean <- chron(ByStem_Thuja_Spline)
plot(ByStem_Thuja_Spline_Mean)

ByStem_Thuja_ModNegExp <- detrend(ByStem_Thuja, method = c("ModNegExp"))
ByStem_Thuja_ModNegExp_Mean <- chron(ByStem_Thuja_ModNegExp)
plot(ByStem_Thuja_ModNegExp_Mean)

ByStem_Thuja_Mean <- detrend(ByStem_Thuja, method = c("Mean"))
ByStem_Thuja_Mean_Mean <- chron(ByStem_Thuja_Mean)
plot(ByStem_Thuja_Mean_Mean)

ByStem_Thuja_Ar <- detrend(ByStem_Thuja, method = c("Ar"))
ByStem_Thuja_Ar_Mean <- chron(ByStem_Thuja_Ar)
plot(ByStem_Thuja_Ar_Mean)

ByStem_Thuja_Friedman <- detrend(ByStem_Thuja, method = c("Friedman"))
ByStem_Thuja_Friedman_Mean <- chron(ByStem_Thuja_Friedman)
plot(ByStem_Thuja_Friedman_Mean)

ByStem_Thuja_ModHugershoff <- detrend(ByStem_Thuja, method = c("ModHugershoff"))
ByStem_Thuja_ModHugershoff_Mean <- chron(ByStem_Thuja_ModHugershoff)
plot(ByStem_Thuja_ModHugershoff_Mean)
...
ByStem_Merged$NoDetrend_Thuja <- ByStem_Thuja_NoDetrend_Mean$xxxstd

ByStem_Merged$Spline <- ByStem_Spline_Mean$xxxstd
ByStem_Merged$Spline_Thuja <- ByStem_Thuja_Spline_Mean$xxxstd
ByStem_Merged$ModNegExp <- ByStem_ModNegExp_Mean$xxxstd
ByStem_Merged$ModNegExp_Thuja <- ByStem_Thuja_ModNegExp_Mean$xxxstd
ByStem_Merged$Mean <- ByStem_Mean_Mean$xxxstd
ByStem_Merged$Mean_Thuja <- ByStem_Thuja_Mean_Mean$xxxstd
ByStem_Merged$Ar <- ByStem_Ar_Mean$xxxstd
ByStem_Merged$Ar_Thuja <- ByStem_Thuja_Ar_Mean$xxxstd
ByStem_Merged$Friedman <- ByStem_Friedman_Mean$xxxstd
ByStem_Merged$Friedman_Thuja <- ByStem_Thuja_Friedman_Mean$xxxstd
ByStem_Merged$ModHugershoff <- ByStem_ModHugershoff_Mean$xxxstd
ByStem_Merged$ModHugershoff_Thuja <- ByStem_Thuja_ModHugershoff_Mean$xxxstd

ByStem_Merged$SampleDepth <- ByStem_Spline_Mean$samp.depth
ByStem_Merged$SampleDepth_Thuja <- ByStem_Thuja_Spline_Mean$samp.depth
...
###Landsat Data###
Landsat <- read.csv('M20_Landsat.csv', row.names = 1) #Update for each site
...
###Export###
write.csv(ByStem_Merged,"M20_ByStem_Chronologies.csv") #Update for each site
write.csv(Landsat_Merged, "M20_Landsat_Chronologies.csv") #Update for each site
